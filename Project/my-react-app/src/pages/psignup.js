...
const PatientSignUp = () => {
  ...
  return (
    <div className="MacbookPro141 w-full  h-screen bg-stone-900 flex justify-between items-center">
      <div className="Bg  w-[70%] h-full p-7 flex-col justify-start items-start inline-flex">
        <div className="Logo w-48 h-48 justify-center items-center inline-flex">
          <img alt="Logo" src={Logo} />
        </div>
        <div className="Frame6 self-stretch grow shrink basis-0 justify-center items-center gap-2.5 inline-flex">
      ...
      >
        <div className="w-full h-full px-7 py-5 flex-col justify-center items-center gap-5 inline-flex">
          <div className="ReturnHome h-50 w-40  text-white">
            Return Home?
            <br />
            <button className="underline" onClick={ReturnLandingPage}>
              click here
            </button>
          </div>
          <div className="Frame7 w-64 flex justify-center items-center gap-2.5 ">
            <div className="Login text-white text-2xl font-normal flex justify-center items-center">
          ...
          <div className="Password flex flex-row w-full justify-start items-center ">
            <div className="flex  justify-between py-px h-12 w-full px-5 bg-white rounded-l-2xl flex-grow flex-shrink flex-basis-0 self-stretch text-zinc-800 text-opacity-80 text-base font-normal">
              <input
                value={password}
          ...
          <div className="DontHaveAnAccountClickHere text-center text-white text-base font-normal">
            Already a user?
            <br />
